...
namespace TransformationTests
{
	...
	TEST(Rotate_Right, TOP) {
		...
		EXPECT_EQ(scrambled_test_cube[LEFT][0], scrambled_test_cube_default[BACK][0]);
		EXPECT_EQ(scrambled_test_cube[LEFT][1], scrambled_test_cube_default[BACK][1]);
		EXPECT_EQ(scrambled_test_cube[LEFT][2], scrambled_test_cube_default[BACK][2]);

		EXPECT_EQ(scrambled_test_cube[BACK][0], scrambled_test_cube_default[RIGHT][0]);
		EXPECT_EQ(scrambled_test_cube[BACK][1], scrambled_test_cube_default[RIGHT][1]);
		EXPECT_EQ(scrambled_test_cube[BACK][2], scrambled_test_cube_default[RIGHT][2]);
	...
	TEST(Rotate_Right, CENTER) {
		...
		EXPECT_EQ(scrambled_test_cube[LEFT][3], scrambled_test_cube_default[BACK][3]);
		EXPECT_EQ(scrambled_test_cube[LEFT][4], scrambled_test_cube_default[BACK][4]);
		EXPECT_EQ(scrambled_test_cube[LEFT][5], scrambled_test_cube_default[BACK][5]);

		EXPECT_EQ(scrambled_test_cube[BACK][3], scrambled_test_cube_default[RIGHT][3]);
		EXPECT_EQ(scrambled_test_cube[BACK][4], scrambled_test_cube_default[RIGHT][4]);
		EXPECT_EQ(scrambled_test_cube[BACK][5], scrambled_test_cube_default[RIGHT][5]);
	...
	TEST(Rotate_Right, BOTTOM) {
		...
		EXPECT_EQ(scrambled_test_cube[LEFT][6], scrambled_test_cube_default[BACK][6]);
		EXPECT_EQ(scrambled_test_cube[LEFT][7], scrambled_test_cube_default[BACK][7]);
		EXPECT_EQ(scrambled_test_cube[LEFT][8], scrambled_test_cube_default[BACK][8]);

		EXPECT_EQ(scrambled_test_cube[BACK][6], scrambled_test_cube_default[RIGHT][6]);
		EXPECT_EQ(scrambled_test_cube[BACK][7], scrambled_test_cube_default[RIGHT][7]);
		EXPECT_EQ(scrambled_test_cube[BACK][8], scrambled_test_cube_default[RIGHT][8]);
	...
	TEST(Rotate_Left, TOP) {
		...
		EXPECT_EQ(scrambled_test_cube[RIGHT][0], scrambled_test_cube_default[BACK][0]);
		EXPECT_EQ(scrambled_test_cube[RIGHT][1], scrambled_test_cube_default[BACK][1]);
		EXPECT_EQ(scrambled_test_cube[RIGHT][2], scrambled_test_cube_default[BACK][2]);

		EXPECT_EQ(scrambled_test_cube[BACK][0], scrambled_test_cube_default[LEFT][0]);
		EXPECT_EQ(scrambled_test_cube[BACK][1], scrambled_test_cube_default[LEFT][1]);
		EXPECT_EQ(scrambled_test_cube[BACK][2], scrambled_test_cube_default[LEFT][2]);
	...
	TEST(Rotate_Left, CENTER) {
		...
		EXPECT_EQ(scrambled_test_cube[RIGHT][3], scrambled_test_cube_default[BACK][3]);
		EXPECT_EQ(scrambled_test_cube[RIGHT][4], scrambled_test_cube_default[BACK][4]);
		EXPECT_EQ(scrambled_test_cube[RIGHT][5], scrambled_test_cube_default[BACK][5]);

		EXPECT_EQ(scrambled_test_cube[BACK][3], scrambled_test_cube_default[LEFT][3]);
		EXPECT_EQ(scrambled_test_cube[BACK][4], scrambled_test_cube_default[LEFT][4]);
		EXPECT_EQ(scrambled_test_cube[BACK][5], scrambled_test_cube_default[LEFT][5]);
	...
	TEST(Rotate_Left, BOTTOM) {
		...
		EXPECT_EQ(scrambled_test_cube[RIGHT][6], scrambled_test_cube_default[BACK][6]);
		EXPECT_EQ(scrambled_test_cube[RIGHT][7], scrambled_test_cube_default[BACK][7]);
		EXPECT_EQ(scrambled_test_cube[RIGHT][8], scrambled_test_cube_default[BACK][8]);

		EXPECT_EQ(scrambled_test_cube[BACK][6], scrambled_test_cube_default[LEFT][6]);
		EXPECT_EQ(scrambled_test_cube[BACK][7], scrambled_test_cube_default[LEFT][7]);
		EXPECT_EQ(scrambled_test_cube[BACK][8], scrambled_test_cube_default[LEFT][8]);
